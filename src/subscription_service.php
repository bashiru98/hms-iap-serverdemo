...
class SubscriptionService{
    ...
    const GET_SUBSCRIPTION_URL = self::ROOT_URL."/sub/applications/v2/purchases/get";
    const STOP_SUBSCRIPTION_URL = self::ROOT_URL."/sub/applications/v2/purchases/stop";
    const DELAY_SUBSCRIPTION_URL = self::ROOT_URL."/sub/applications/v2/purchases/delay";
    const RETURN_FEE_SUBSCRIPTION_URL = self::ROOT_URL."/sub/applications/v2/purchases/returnFee";
    const WITHDRAWAL_SUBSCRIPTION_URL = self::ROOT_URL."/sub/applications/v2/purchases/withdrawal";
    ...
    public function getSubscription($subscriptionId, $purchaseToken){
        ...
        // pack the request body
         ...
         $response = AtDemo::httpPost(self::GET_SUBSCRIPTION_URL, $msgBody, 5, 5, $headers);
    ...
    public function stopSubscription($subscriptionId, $purchaseToken){
        ...
        // pack the request body
         ...
         $response = AtDemo::httpPost(self::STOP_SUBSCRIPTION_URL, $msgBody, 5, 5, $headers);
    ...
    public function delaySubscription($subscriptionId, $purchaseToken, $currentExpirationTime, $desiredExpirationTime){
        ...
        $response = AtDemo::httpPost(self::DELAY_SUBSCRIPTION_URL, $msgBody, 5, 5, $headers);
    ...
    public function returnFeeSubscription($subscriptionId, $purchaseToken){
        ...
        $response = AtDemo::httpPost(self::RETURN_FEE_SUBSCRIPTION_URL, $msgBody, 5, 5, $headers);
    ...
    public function withdrawSubscription($subscriptionId, $purchaseToken){
        ...
        $response = AtDemo::httpPost(self::WITHDRAWAL_SUBSCRIPTION_URL, $msgBody, 5, 5, $headers);
