...
class OrderService:
    ...
    def __init__(self):
        ...
        self.verifyTokenUrl = "%s/applications/purchases/tokens/verify" % self.baseUrl
        self.cancelledListPurchaseUrl = "%s/applications/v2/purchases/cancelledList" % self.baseUrl
    ...
    def verifyToken(self, purchaseToken, productId):
        ...
        response = AtDemo.httpPost(self.verifyTokenUrl, str.encode(data), headers)
    ...
    def cancelledListPurchase(self, endAt, startAt, maxRows, queryType, continuationToken):
        ...
        data = json.dumps(bodyDict)
        response = AtDemo.httpPost(self.cancelledListPurchaseUrl, str.encode(data), headers)
        # TODO: display the response as string in console, you can replace it with your business logic.
        print(response)
